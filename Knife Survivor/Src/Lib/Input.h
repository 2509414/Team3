...
#define KEY_SQUAT		(0b100000000000000)			//しゃがむ
#define KEY_SQUAT2		(0b1000000000000000)		//しゃがむ
#define KEY_ATTACK		(0b10000000000000000)		//近接攻撃
#define KEY_ATTACK2		(0b100000000000000000)		//近接攻撃
#define KEY_AORI1		(0b1000000000000000000)		//煽り１
#define KEY_AORI2		(0b10000000000000000000)	//煽り2
#define KEY_2AORI1		(0b100000000000000000000)	//player2煽り１
#define KEY_2AORI2		(0b1000000000000000000000)	//player2煽り2
