...
void HitCheckAttackToObject() {

	
	//攻撃が出てなかったら判定しない
	if (attack.m_isActive == true)
	{
		bool hit = ChenkHitSquareToSquare(attack.m_pos, 35, 35, knife2.m_pos, 30, 30);
...
void HitCheckAttack2ToObject() {


	//攻撃が出てなかったら判定しない
	if (attack.m_isActive == true)
	{
		bool hit = ChenkHitSquareToSquare(attack2.m_pos, 35, 35, Knife1.m_pos, 30, 30);
